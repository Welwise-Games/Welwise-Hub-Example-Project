...
namespace ParrelSync
{
    ...
    public class ListOfStringsPreference
    {
        ...
        public string Serialize(List<string> data)
        {
            ...
            foreach (var item in data)
            {
                ...
                {
                    Debug.LogError("Unable to serialize this value [" + item +
                                   "], it contains the serialization token [" + serializationToken + "]");
                    continue;
                }
    ...
    public class Preferences : EditorWindow
    {
        ...
        public static BoolPreference AlsoCheckUnityLockFileStaPref =
            new BoolPreference("ParrelSync_CheckUnityLockFileOpenStatus", true);
        ...
        /// </summary>
        public static ListOfStringsPreference OptionalSymbolicLinkFolders =
            new ListOfStringsPreference("ParrelSync_OptionalSymbolicLinkFolders");
