...
//                     Debug.LogError(
//                         "SceneCondition could not be found. Upgrading scene checker components will not function.");
//             }
//
...
//                     Debug.LogWarning(
//                         $"DistanceCondition has been created at {savePath}. Place this file somewhere within your project and change settings to your liking.");
//                 }
//
//                 if (_distanceCondition == null && error)
//                     Debug.LogError(
//                         "DistanceCondition could not be found. Upgrading proximity checker components will not function.");
//             }
//         }
//
//
...
//             {
//                 Transform target;
//                 if (nt1 is MirrorNetworkAnimator mc1)
//                     target = mc1.target;
//                 else
//                     target = go.transform;
//                 Replace(nt1, target);
